...
function Modal({ children, isOpen, onClose }) {
  ...
  return (
    <div
      className={`text-dark dark:text-light fixed inset-0 md:ml-20 ml-14 my-auto z-50 flex justify-center ${!closeAnimation ? "h-0 duration-300" : "h-full duration-700"} transition-all ease-in-out opacity mr-2 border-dark delay-300`}
    >
      <div
